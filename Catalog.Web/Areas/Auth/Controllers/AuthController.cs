...
using Catalog.Web.Areas.Auth.Models;
using AutoMapper;
...
namespace Catalog.Web.Areas.Auth.Controllers
{
    public class AuthController : BaseController
    {
        ...
        {
            var user = ParticipantContext.Users.Single(CurrentUser.Id);
        ...
        {
            var user = ParticipantContext.Users.ByEmail(email); 
