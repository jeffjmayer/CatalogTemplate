...
namespace Catalog.Web
{
    public class MvcApplication : System.Web.HttpApplication
    {
        protected void Application_Start()
        {
            ...
            WebSecurity.InitializeDatabaseConnection("MASOrder", "User", "Id", "Email", autoCreateTables: true);
            ...
            Catalog.Domain.User.Init(table: "User", key: "Id");
        ...
        void LogException(Exception exception)
        {
            ...
            try
            {
                ...
                ParticipantContext.Errors.Insert(error);
            }
