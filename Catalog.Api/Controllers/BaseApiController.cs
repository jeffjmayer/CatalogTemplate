...
namespace Catalog.Api.Controllers
{
    ...
    public class BaseApiController : ApiController
    {
        ...
        static BaseApiController()
        {
            if (!initialized)
            {
                Mapper.CreateMap<Participant, ApiParticipant>().ForMember(dest => dest.Href, opt => opt.MapFrom(src => src.Id.ToParticipantHref()));
                ...
                Mapper.CreateMap<ApiParticipant, Participant>().ForMember(dest => dest.Id, opt => opt.MapFrom(src => src.Href.ToId()));
    ...
    public static class HrefHelper
    {
        ...
        public static string ToParticipantHref(this int? id) { return root + "Participants/" + id; }
